...
<html>
<head>
<title>Naturals | Update Services</title>
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				  ...
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  <div class="modal-header">
						<h5 class="modal-title" id="eventDetail">EDIT SERVICE</h5>
				...
				<div class="modal fade" id="editinc" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="editmod" aria-hidden="true">
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  <div class="modal-header">
						<h5 class="modal-title" id="eventDetail">EDIT INCENTIVE</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						  <span aria-hidden="true">&times;</span>
						</button>
					  </div>
	...
	<!-- Classie -->
		...
		$(document).ready(function() {
			...
			$("body").on("click",".update",function() {
				...
				$("body").on("click",".updatein",function() {
				var dataString = $("#UpdateForm").serialize()+"&action=updatein";
				$.ajax({
						type: 'POST',
						url: 'ajax/serviceajax.php',
						timeout: 100000,
			...
			$("body").on("click",".view",function() {
				...
				$("body").on("click",".editin",function() {
					var id=$(this).attr('id');
					//alert(id);
					var dataString  = "action=editin&id="+id;
					$.ajax({
						type: 'POST',
						url: 'ajax/serviceajax.php',
						timeout: 100000,
						...
						success: function(server_response){
							if(server_response.trim() != ""){
								$(".insidebody3").html(server_response);
								}
							},
						error: function(xhr, status, error) {
							if(status === "timeout") {

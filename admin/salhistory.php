						...
						<div class="form-body">
							...
							<form action='' target="_blank"  method='POST' id='ProductSaleReportForm' name='customerreeportform'>
								<div class='row'>
										...
										<div class='col-lg-2 col-md-12 col-sm-12' style='float:right;text-align:right'>
											<label>With GST<input checked='true' type='radio' name='tygs' value='WIG' id='GstWi'/></label>
											<label>Without GST<input type='radio' name='tygs' id='GstWiO' value='WOG' /></label>
											<label>GST Alone<input type='radio' name='tygs' value='GSA'  id='GSTALONE'/></label>
										</div>

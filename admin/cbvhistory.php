...
<html>
<head>
<title>naturals | Customer History</title>
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<form action='' target="_blank"  method='POST' id='CustomerReportForm' name='customerreeportform'>
								<div class='row'>
									
										<div class='col-lg-2 col-md-6 col-sm-6'>
											<label>Category	</label>
											<select name='cate' id='cate' class='form-control'>
												<option value='CBW'> Customer Bill Wise Histotry</option>
												<option value='CNO'> Customer No of Visists Histotry</option>
											</select>
										</div>
										<div class='col-lg-2 col-md-6 col-sm-6'>
	...
	<!-- Classie -->
		...
		$(document).ready(function() {
			$("body").on("click","#Pdf",function() {
				...
				$("#CustomerReportForm").attr("action","cuerepdf.php");
			});
			$("body").on("click","#Excel",function() {				
				$("#CustomerReportForm").attr("action","cuerexcel.php");
			});
			$("body").on("click","#Query",function() {
				var dataString ="action=query&"+$("#CustomerReportForm").serialize();
			//	alert(dataString);
				$.ajax({
						type: 'POST',

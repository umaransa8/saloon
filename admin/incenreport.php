...
<html>
<head>
<title>Naturals | Incentive History</title>
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<form action='' target="_blank"  method='POST' id='IncentiveReportForm' name='Incentivereeportform'>
								<div class='row'>
...
setInputDate("#EndDate");
		$(document).ready(function() {
			$("body").on("click","#Pdf",function() {
				...
				$("#IncentiveReportForm").attr("action","starepdf.php");
			});
			$("body").on("click","#Excel",function() {				
				$("#IncentiveReportForm").attr("action","cuerexcel.php");
			});
			$("body").on("click","#Query",function() {
				var dataString ="action=query&"+$("#IncentiveReportForm").serialize();
				//alert(dataString);
				$.ajax({
						type: 'POST',
						url: 'ajax/incentivereajax.php',
						timeout: 100000,
						data:dataString,	
						success: function(server_response){

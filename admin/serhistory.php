...
<html>
<head>
<title>naturals | Product Service Report</title>
	...
	<!-- Classie -->
		...
		<script>
		 ...
		 $("body").on("click","#Pdf",function() {				
				$("#ProductSaleReportForm").attr("action","serrepdf.php");
			});
		 ...
		 function loadser() {				
			...
			loadcate();
			 function loadcate() {				
				var dataString = "action=loadcategory";
				$.ajax({
					type: 'POST',
					url: 'ajax/load.php',
					timeout: 100000,
